...
<body>
    ...
    // Define $status_filter before using it in the HTML
    ...
    <div class="main-content">
        ...
        <!-- Pagination - Show only if there's more than 1 page -->
    ...
    <!-- Complete Task Modal (Submit proof to complete task) -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // User accept the task (so it changes from pending to in-progress)
